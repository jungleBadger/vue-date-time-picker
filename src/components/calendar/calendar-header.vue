<template>
	<header class="calendar-header">
		<nav class="calendar-header-nav">
			<button @click.stop="backOneMonth" class="nav-button" style="margin-left: 3px;">
				<span class="icon">
			...
			<h3 class="calendar-header-title">{{selectedMonthName}} {{selectedYear}}</h3>
			<button @click.stop="advanceOneMonth" class="nav-button" style="margin-right: 3px;">
				<span class="icon">
